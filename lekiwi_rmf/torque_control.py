...
def react_to_command_silence(disarm_on_failure: bool, cut_torque, hold_position) -> str:
    """Stop the robot when commands stop arriving; cut servo torque only in strict mode.
