...
CAMERAS="{front: {type: opencv, index_or_path: $FRONT, width: 640, height: 480, fps: 30, rotation: 180},
          wrist: {type: opencv, index_or_path: $WRIST, width: 480, height: 640, fps: 30, rotation: 90}}"
